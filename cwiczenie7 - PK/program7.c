...
/*
    ...
    • Stworzyć dwa oddzielne moduły z funkcjami dla semaforów oraz pamięci dzielonej (jeden moduł to plik nagłówkowy .h i plik źródłowy .c o tej samej 
      nazwie rdzeniowej).
    ...
    • W pliku Makefile umieścić oddzielne uruchomienie programu dla biblioteki statycznej oraz dwa sposoby uruchomienia dla biblioteki dzielonej 
      (patrz przykład w StartSO).
